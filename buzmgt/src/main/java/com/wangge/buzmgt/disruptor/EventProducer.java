...
public class EventProducer {
  ...
  // 填充Event
  private static final EventTranslatorOneArg<MallOrder, MallOrder> TRANSLATOR = new EventTranslatorOneArg<MallOrder, MallOrder>() {
  ...
  private static final String ORDER_SQL = "SELECT O.ID,O.MEMBER_ID,O.ORDER_NUM,O.SHIP_STATUS ,o.PAY_STATUS FROM SJZAIXIAN.SJ_TB_ORDER O";
  ...
  public void getMallOrder(EntityManager em) {
    ...
    String tenMinutesOrderSql = ORDER_SQL + " WHERE  O.SHIP_TIME BETWEEN to_date('" + timeoftenMinutes
        + "','yyyy-mm-dd hh24:mi:ss') AND to_date('" + nowTime + "','yyyy-mm-dd hh24:mi:ss')";
    ...
    for (Object[] order : orderList) {
      ...
      mallorder.setMember_id(order[1] + "");
      mallorder.setOrderNum(order[2] + "");
      mallorder.setPayStatus(order[3] + "");
