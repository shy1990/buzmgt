...
/**
 * 
 * 功能: 时间格式化 详细： 类名： DateUtil 作者： jiabin 版本： 1.0 日期： 2015年7月15日下午6:24:14
 */
public class DateUtil {
  ...
  /**
   * 
   * 名称: dateMinDiff 功能: 获取两个日期的分钟差 参数: @param stime 参数: @param etime 参数: @param
   * format 参数: @return
   */
  ...
  /**
   * 
   * 名称: dateSecDiff 功能: 获取两个时间之间之差换算成秒数 作者 : jia 参数: @param stime 参数: @param
   * etime 参数: @param format 参数: @return
   */
  ...
  /**
   * 
   * 名称: getWeekendNum 功能: 获取两个日期之间的周末天数 参数: @param startDate 参数: @param endDate
   * 参数: @param format 参数: @return
   */
  public static int getWeekendNum(String startDate, String endDate, String format) {
    ...
    for (int i = 0; i < size; i++) {
      String day = yearMonthDayList.get(i);
  ...
  /**
   * 
   * 名称: getWeekNum 功能: 计算两个日期内周几的天数 参数: @param startDate 参数: @param endDate
   * 参数: @param format 参数: @param week 参数: @return
   */
  ...
  /**
   * 
   * 名称: getDaysOfMonth2 功能: 获取每月天数 参数: @param year 参数: @param month 参数: @return
   */
  ...
  /**
   * 
   * 名称: getWeekOfDate 功能: 获取当前日期是周几 参数: @param dt 参数: @return
   */
  ...
  /**
   * 
   * 名称: ifWeek 功能: 判断是否为周末 参数: @param bDate 参数: @return
   */
  ...
  /**
   * 
   * 名称: compare_date 功能: 判断两个日期大小 参数: @param DATE1 参数: @param DATE2 参数: @param
   * format 参数: @return
   */
  ...
  /**
   * 
   * 名称: getWeeksByDates 功能: 根据两个日期计算出该时间段有几周 参数: @param strBefore 参数: @param
   * strAfter 参数: @return 参数: @throws Exception
   */
  ...
  /**
   * 
   * 名称: findDates 功能: 获取指定时间段内的所有日期 参数: @param dBegin 参数: @param dEnd
   * 参数: @return
   */
  ...
  /**
   * 
   * 名称: findweeksOfYear 功能: 获取指定日期属于该年的第几周 作者 : lxb 时间 : 2015年1月5日 上午10:00:49
   * 参数: @param date 参数: @param format 参数: @return
   */
  ...
  /**
   * 
   * 名称: getDatesByweek 功能: 根据某年的第几周的第几天获得该天的日期 作者 : lxb 时间 : 2015年1月5日
   * 下午3:38:40 参数: @param week 参数: @param year 参数: @param dayOfweek 参数: @return
   */
  ...
  /**
   * 
   * 名称: getMonthsByDates 功能: 通过两个时间段获取该时间段内的月数 作者 : lxb 时间 : 2015年1月8日
   * 上午10:58:37 参数: @param dBegin 参数: @param dEnd 参数: @return
   * 
  ...
  /**
   * 
   * 名称: getYearsByDates 功能: 根据指定时间段获取该时间段内的年数 作者 : lxb 时间 : 2015年1月8日
   * 上午11:11:04 参数: @param dBegin 参数: @param dEnd 参数: @return
   * 
   * @throws ParseException
   */
  ...
  /**
   * 
   * 名称: isDateBefore 功能: 判断时间date1是否在时间date2之前 作者 : zh 时间 : 2015年2月10日
   * 上午11:52:47 参数: @param date1 参数: @param date2 参数: @return
   */
  ...
  /**
   * 
   * 名称: daysBetween 功能: 计算两个日期之间相差的天数 参数: @param smdate 较小的时间 参数: @param bdate
   * 较大的时间 参数: @return 相差天数 参数: @throws ParseException
   */
  ...
  /**
   * 
   * 名称: daysBetween 功能: 计算两个日期之间相差天数（字符串的日期格式的计算） 参数: @param smdate 参数: @param
   * bdate 参数: @return 参数: @throws ParseException
   */
  ...
  /**
   * 
   * 名称: formatDate 功能: 将毫秒数换算成x天x时x分x秒x毫秒 参数: @param ms 参数: @return
   */
  ...
  /**
   * getDayBetweenNextMonth:计算某一日期距离下月初还有多少天. <br/>
   * 
   * @author yangqc
   * @param oldDate
   *          前一个日期
   ...
   * @since JDK 1.8
   */
  public static int getDayBetweenNextMonth(Date oldDate) {
    
    try {
      Date nextMonth = sdf.parse(getPreMonth(new Date(), 1));
      return daysBetween(oldDate, nextMonth);
    } catch (ParseException e) {
      e.printStackTrace();
    }
    return 0;
  ...
  /**
   * getDayOfCurrentMonth:获取当前月份有多少月. <br/>
   * 
   * @author yangqc
   * @return
   * @since JDK 1.8
