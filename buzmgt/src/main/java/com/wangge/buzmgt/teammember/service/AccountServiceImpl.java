...
public class AccountServiceImpl implements AccountService {
  ...
  @Override
  public List<AccountBean> selectAccountByPositionAndStatus(String orgName,String status,PageRequest page) {
...
//                  "JOIN SYS_ORGANIZATION o ON u.ORGANIZATION_ID = o.ORGANIZATION_ID  JOIN SYS_REGION re   ON m.REGION_ID = re.REGION_ID  where 1=1 ";
    ...
    sb.append( "select v.oname, v.usedId, v.truename,v.aname,v.rname,v.status from (");
     sb.append(" SELECT o.NAME as oname,u.USER_ID  usedId  ,m.TRUENAME   truename,re.NAME as aname,sr.NAME as rname,u.STATUS status FROM    SYS_USER u");
     ...
     sb.append(" JOIN SYS_ORGANIZATION o ON u.ORGANIZATION_ID = o.ORGANIZATION_ID  JOIN SYS_REGION re   ON m.REGION_ID = re.REGION_ID ) v where 1=1");
