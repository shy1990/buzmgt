...
//                  "JOIN SYS_ORGANIZATION o ON u.ORGANIZATION_ID = o.ORGANIZATION_ID  JOIN SYS_REGION re   ON m.REGION_ID = re.REGION_ID  where 1=1 ";
    ...
    sb.append( "select v.oname, v.usedId, v.truename,v.aname,v.rname,v.status,v.rid from (");
     sb.append(" SELECT o.NAME as oname,u.USER_ID  usedId ,u.username as username, m.TRUENAME   truename,re.NAME as aname,sr.NAME as rname,u.STATUS status,re.REGION_ID as rid FROM    SYS_USER u");
    ...
    if(orgName!=null && !"".equals(orgName)){
      ...
      if(searchParam != null && !"".equals(searchParam)){
        sb.append( " and (v.username like '%"+searchParam+"%' or v.truename like '%"+searchParam+"%')");
      }
    }
