...
public class RegionController {
	...
	@ResponseBody
	public ResponseEntity<Collection<Region>> getRegionById(String id,HttpServletRequest request){
		   Region region = regionService.getRegionById(id);
		return new ResponseEntity<Collection<Region>>(region.getChildren(),HttpStatus.OK);
	}
