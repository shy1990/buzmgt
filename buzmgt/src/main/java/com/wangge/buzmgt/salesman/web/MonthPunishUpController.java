...
////    @ResponseBody
//    public  List findAll(@RequestParam(value = "page", defaultValue = "0") Integer page,
//                                       @RequestParam(value = "size", defaultValue = "3") Integer size){
//        System.out.println("*************");
//        Sort sort = new Sort(Sort.Direction.DESC, "id");
//        Pageable pageable = new PageRequest(page, size, sort);
//        List list = new ArrayList<>();
//        list.add(service.findByPage(pageable));
//        list.add("测试1");
//        list.add("测试2");
//        Page p = service.findByPage(pageable);
//        return list;
//    }
...
////    @JSONFormat(filterField = {"SalesMan.user","region.parent","region.children"})
//    @JSONFormat(filterField = {"SalesMan.user","region.children"})
//    public ResponseEntity<JsonResponse> findAll(@RequestParam(value = "page", defaultValue = "0") Integer page,
//                                                @RequestParam(value = "size", defaultValue = "3") Integer size){
//        System.out.println("*************");
//        Sort sort = new Sort(Sort.Direction.DESC, "id");
//        Pageable pageable = new PageRequest(page, size, sort);
//        return   new ResponseEntity<JsonResponse>(new JsonResponse(service.findByPage(pageable)), HttpStatus.OK) ;
//    }
...
//    @JSONFormat(filterField = {"SalesMan.user", "region.children"})
    @ResponseBody
    public JSONObject findAll(@RequestParam(value = "page", defaultValue = "0") Integer page,
                                       @RequestParam(value = "size", defaultValue = "3") Integer size,
