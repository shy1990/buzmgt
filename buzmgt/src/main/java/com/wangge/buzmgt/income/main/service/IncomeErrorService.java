...
public interface IncomeErrorService {
   ...
   *          商品id
   * @param type
   *          规则类型 0 达量设置 1 品牌型号 2 价格区间3叠加奖励 4.达量奖励
   * @param keyId
   *          规则id
   * @since JDK 1.8
   */
   ...
   *          商品id<br/>
   * @param type
   *          规则类型 0 达量设置 1 品牌型号 2 价格区间3叠加奖励 4.达量奖励<br/>
   * @param keyId
   *          规则id
   * @since JDK 1.8
   */
  void saveHedgeError(String orderno, String userId, String errorInfo, String goodId, Integer type, Long keyId);
}
