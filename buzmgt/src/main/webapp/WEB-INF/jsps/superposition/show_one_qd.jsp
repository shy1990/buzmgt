...
<head>
    ...
    <script type="text/javascript">
        function yes(id,planId) {
            $.ajax({
                url: '<%=basePath%>superposition/stop/' + id,
                data: {checkStatus: '3'},
                dataType: 'json',
                type: 'POST',
            ...
            <li style="margin-bottom: 200px">
                ...
                <c:if test="${superposition.checkStatus == '1' && check eq '1' && (superposition.auditor == auditor || auditor == '1')}">
                    <dl class="dl-horizontal">
                        <dd>
                            <div>
                                <button class="btn btn-sm btn-zz " onclick="yes('${superposition.id}','${superposition.planId}')">通过
                                </button>
