...
<head>
    ...
    <script id="group-all-template" type="text/x-handlebars-template">
        ...
        <li>
            <dl class="dl-horizontal">
                ...
                <dd>
                    {{#each groupUsers}}
                    <span class="notice" data-userid="{{userId}}" data-target="#tjry" data-groupname="{{../groupName}}"
                          data-toggle="modal"> {{userName}}</span>
                    {{/each}}
    ...
    <script id="number-add-template" type="text/x-handlebars-template">
        ...
        <div class="col-sm-8 ryfz-box">
            <a href="#" class="J_group" data-target="#tjry" data-index="{{@index}}" data-groupname="{{groupName}}"
               data-toggle="modal">
...
<div class="content main">
    ...
    <script type="text/javascript" src="static/superposition/super_add.js"
            charset="utf-8"></script>
    <script type="text/javascript">
