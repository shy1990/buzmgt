...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>static/phone-set/css/comminssion.css">
    ...
    <style>
        ...
        .icon-riz {
            background: url("img/rizi.png") no-repeat center;
        }

        .icon-reny {
            background: url("img/shry.png") no-repeat center;
        }
    </style>
</head>
<body>
