...
<body >
				        <div id="j_page_main" class="content main">
							<h4 class="page-header-region"><i class="icon region-switch-icon"></i>区域切换
							</h4>  
							<div class="row">
										<div class="col-md-12">
											<div class="box border orange">
											  ...
											  <div class="box-title">
												<div class="row">
													<div class="col-md-9">
															<div class="role-region-title"><i class="title-icon"></i>区域结构 
													...
													<div class="form-group title-form">
														...
														<div class="input-group ">
															<input type="text" class="form-control" name="regionName" id="regionName"
																placeholder="请输入区域名字"> <a type="sumbit"
																class="input-group-addon" id="goSearch"
																onclick="findRegionByName();"><i
...
<!--    <script src="static/js/jquery/jquery-2.1.4.min.js" type="text/javascript" charset="utf-8"></script> -->
   ...
   <script src="static/js/region/regionTreePersonal.js" type="text/javascript" charset="utf-8"></script>
