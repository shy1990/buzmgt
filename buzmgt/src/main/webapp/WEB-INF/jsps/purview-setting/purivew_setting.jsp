									...
									<div class="role-list">
										...
										<ul class="nav nav-tabs">
											<li class="active"><a href="#tab_1_1" data-toggle="tab">
													区域总监 <i class="icon delete-icon"><span
									...
									<div class="setting-list tab-content">
										<div class=" tab-pane  active" id="tab_1_1">
											...
											<div class="j_scroller"
												...
												<ul class="nav nav-purview">
													<li class="active"><a class="j_dropdown qx-second-box"><i
														...
														<ul class="qx-second">
															...
															<li><a><i class="icon second-icon zzjg-icon"></i>组织结构
																	<label class="pull-right"> <input type="radio"
																		name="qyhf" checked value="no-visible" /> <i
																		class="j_radio_setting pull-right icon visible-icon"></i>
																</label> <label class="pull-right"> <input type="radio"
																		name="qyhf" value="visible" /> <i
													...
													<li><a class="qx-second-box"><i
															class="icon cpxlmk-icon"></i> 产品销量模块</a></li>
												</ul>
											</div>
										</div>
										...
										<div class="tab-pane fade" id="tab_1_3">
											...
											<p>Yesterday I was on my way to class, when a black cat
												...
												was about so I asked him if I could step around him because
												he was bad luck, but he simply meowed and then disappeared.
												I was a bit worried that maybe he'd teleported to somewhere
												dangerous, but a wizard came and assured me that it was
												alright. I threw my Zune at him because I was 78% sure he
												was lying. The wizard roared at me and sentenced my mother
												to thirty five years of chain smoking. I was sad. [do]</p>
										</div>
									</div>
								</div>
							</div>
