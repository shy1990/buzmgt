												...
												<div class="col-sm-3 cl-padd">
													<div class="ratio-box">
														<div class="ratio-box-dd">
															...
															<a class="text-bluee" href="" data-toggle="modal"
																data-target="" onclick="modify_money('${oil.id}','${oil.kmRatio}','${oil.region.id }')">修改</a> <a class="text-bluee"
																href="" data-toggle="modal" data-targt="" onclick="delete_byId_money('${oil.id}','${oil.region.id }')">删除</a>
														</div>
													</div>
												</div>
											</c:if>
