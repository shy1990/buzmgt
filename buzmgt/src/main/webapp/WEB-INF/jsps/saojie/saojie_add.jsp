...
<title>扫街添加</title>
<!-- Bootstrap -->
<link href="../static/bootstrap/saojie/css/bootstrap.min.css" rel="stylesheet" />
							...
							<div class="member-add-box box border red">
								...
								<div class="box-body">
									...
									<div class="tab-content">
										...
										<!--box-list-->
										<form class="member-from-box form-horizontal" action="/saojie/saveSaojie" name="form" method="post">
											<div class="member-from col-md-8 col-md-offset-1 col-sm-10">
													<div class="form-group">
														...
														<div class="input-group col-sm-9 ">
															...
															<select class="form-control" name="saojieMan" id="saojieMan" onchange="queryTown()">
													...
													<div class="form-group">
														...
														<div style="padding: 0;" class="col-sm-9">
															<div class="input-group date form_date col-sm-6"
																...
																data-link-format="yyyy-mm-dd" id="starttime">
																<span class="input-group-addon" id="basic-addon1"><i
																	class="member-icon saojie-time-icon"></i></span> <input
																	class="form-control" size="16" type="text" name="beginTime" value=""
																	readonly placeholder="请选择开始时间" /> <span
															...
															<div class="input-group date form_date col-sm-6"
																data-date="" data-date-format="yyyy-mm-dd"
																data-link-field="dtp_input2"
																data-link-format="yyyy-mm-dd" id="endtime">
																<span class="input-group-addon" id="basic-addon1"><i
																	class="member-icon saojie-time-icon"></i></span> <input
																	class="form-control" size="16" type="text" name="expiredTime" value=""
																	readonly placeholder="请选择结束时间" /> <span
																	class="input-group-addon"><span
																	class="glyphicon glyphicon-remove"></span></span> <span
																	class="input-group-addon"><span
																	class="glyphicon glyphicon-calendar"></span></span> <input
											...
											<div class="form-group">
												<div class="input-group col-sm-10 col-sm-offset-4">
													<button class="btn btn-danger col-sm-3"　onclick="toSubmit();">确定保存</button>
												</div>
											</div>
											</form>
										</div>
