...
<body>
	...
	<div class="main">
		<h4 class="page-header">
			<i class="ico icon-saojie-add"></i>添加扫街 <a href="/saojie/saojieList"
				class="btn btn-blue member-add-btn" type="button"> <i
				class="icon glyphicon glyphicon-share-alt"></i> 返回列表
			</a>
		</h4>

		<div class="row">
			<div class="col-md-12">
				<div class="saojie-add-box box border blue">
					<div class="box-title">
									...
									<div class="member-from col-md-8 col-md-offset-1 col-sm-10">
										<div class="form-group">
											...
											<div class="input-group col-sm-10 ">
												...
												<select class="form-control" id="saojieMan"
											...
											<div class="col-sm-10" style="padding: 0;" id="pid">
												<div class="col-sm-6 p-t" id="btType">
													<button id="btn" class="btn btn-white btn-w-m" text="点击"
														type="button" onclick="AddOrder(btType)">
										...
										<div class="form-group">
											<div style="padding: 0;"  class="col-sm-10 col-sm-offset-2 " id="pid">
