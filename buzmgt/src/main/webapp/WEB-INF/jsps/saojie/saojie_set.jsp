<%@ page language="java"
	import="java.util.*,com.wangge.buzmgt.region.entity.*"
...
<link rel="stylesheet" type="text/css"
	href="../static/saojie/saojie-set.css" />
...
<body>
	<div class="content main">
		<h4 class="team-member-header page-header ">
			<i class="icon icon-saojie-set"></i> 扫街设置 <a
				href="/saojie/saojieList" class="btn btn-blue member-add-btn"
							...
							<div class="table-responsive">
								<table class="table">
									<c:forEach var="saojie" items="${list}" varStatus="s">
										<tr>
											<td><input type="hidden" id="orderlist" /> <input
												type="hidden" id="saojieId${saojie.order-1 }"
												value="${saojie.id }" /> <c:if test="${saojie.order < 10}">
													<span class="icon-tag-span">0${saojie.order }</span>
												</c:if> <c:if test="${saojie.order >= 10}">
	...
	<!-- 模态框（Modal） -->
	<div class=" modal modal-blue fade" id="auditModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-blue" onclick="btnAudit();">
						审核通过</button>
				</div>
			</div>
			<!-- /.modal-content -->
	...
	<script src="../static/saojie/saojie-set.js" type="text/javascript"
