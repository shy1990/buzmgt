						...
						<div class="modal-content">
									...
									<div class="form-group">
										...
										<div class="col-md-9 ">
											<input type="text" placeholder="请填写角色名称" class="form-control"
												name="name" id="name" onchange="tocheckname()" /> <span
												id="gradeInfo"></span>
										</div>
										<label class="pull-right col-md-3 control-label msg-error"
											id="nameError">请填写角色名称</label>
									</div>
									<div class="form-group">
							...
							<div class="modal-footer">
								<div class="col-md-3 col-md-offset-8">
									<button type="submit" onclick="addRole()" id="bt"
										class="btn col-xs-12 btn-danger" disabled>确定</button>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function tocheckname() {
		...
		$.post(url, function(data) {
			...
			if (data === 'err') {
				$("#gradeInfo").html(
						"<font color=\"red\">您输入的角色存在！请重新输入！</font>");
