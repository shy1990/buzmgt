...
<body>
	<div class="main">
		<h4 class="page-header">
			<i class="icon team-member-add-icon"></i>修改账号 
			<a href="/accountManage" class="btn btn-blue member-add-btn"
					...
					<div class="box-body">
						...
						<div class="member-from col-md-6 col-md-offset-2 col-sm-10">
							<form id = "addSalesManForm" name="regForm" class="member-from-box form-horizontal"
								action="/saveAccount" method="post"
								onsubmit="javascript:return checkForm()">
								<div class="form-group">
									<input type="hidden" id="userId" name="userId" value="${man.id}"/>
									<input type="hidden" id="organization1" name="organizationId" value="${man.user.organization.id}"/>
									<label class="col-sm-3 control-label">用户名:</label>
									<div class="input-group col-sm-9">
										<span class="input-group-addon" id="basic-addon1"><i
											class="member-icon member-name-icon"></i></span> <input type="text" class="form-control" id="username" name="username"  value="${man.user.username}" readonly/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group col-sm-9">
										...
										<input type="text" class="form-control" id="truename" value="${man.truename}"
								...
								<div class="form-group">
									...
									<div class="input-group col-sm-9 ">
										<span class="input-group-addon" id="basic-addon1"><i
											...
											class="form-control" id="jobNum" name="jobNum" value="${man.jobNum}"
											placeholder="请填写个人共工号" onblur="checkJobNum()" readonly>
									</div>
								...
								<div class="form-group">
									...
									<div class="input-group col-sm-9 ">
										<span class="input-group-addon" id="basic-addon1"><i
											...
											class="form-control" id="mobile" name="mobile" value="${man.mobile}"
		...
		$.ajax({
			...
			success : function(result){
			   if (result) {
				   var role = $("#role1"); ;
				    role.empty();  
					role.append("<option value = "+rid+" selected='selected'>"+rname+"</option>");
	               for(var i=0;i<result.length;i++){
