...
<!--                 <button class="btn  bnt-sm ph-btn-add" id="btnadd"><span class="text-strong">+</span></button> -->
        ...
        <div class="jttcsz">
            ...
            <div class="rwzsql">
                ...
                <span class=" hden-rwl">500台</span>
                <input type="hidden" name="numberFirst" value="" />
                <span class=" hden-rwl">1000台</span>
      					<input type="hidden" name="numberSecond" value="" />
                <span class=" hden-rwl">1000台</span>
      					<input type="hidden" name="numberThird" value="" />
            ...
            <div class="jfgz">
                ...
                <div class="jfbox J_RULE" >
                    <div class="col-sm-4 jfbox-box">
                        <span class="text-publ"> 实际销量 ＜</span> <span class="text-nub">500 </span><span
                            class="text-publ">台</span> &nbsp;&nbsp; <span
                            class="text-gery text-size-12">提成：</span><input
                            type="text" class="ph-inpt" placeholder="5.00"> <span class="text-publ">元/台</span>
                    </div>
                    <div class="col-sm-4 jfbox-box">
                        <span class="text-nub">500 </span><span class="text-publ">台 ≤实际销量＜ </span><span
                            class="text-nub"> 1000</span><span class="text-publ">台</span> &nbsp;&nbsp;
                        <span class="text-gery text-size-12">提成：</span><input type="text" class="ph-inpt"
                                                                              placeholder="5.00"> <span
                            class="text-publ">元/台</span>
                    </div>
                    <div class="col-sm-4 jfbox-box">
                        <span class="text-nub">1000 </span><span class="text-publ">台 ≤ 实际销量 ＜ </span><span
                            class="text-nub"> 1500</span> <span class="text-publ">元/台</span> &nbsp;&nbsp;
                        <span class="text-gery text-size-12">提成：</span><input type="text" class="ph-inpt"
                                                                              placeholder="5.00"> <span
                            class="text-publ">元/台</span>
                    </div>
                    <div class="col-sm-4 jfbox-box">
                        <span class="text-nub">1500 </span><span class="text-publ">台 ≤ 实际销量</span> &nbsp;&nbsp; <span
                            class="text-gery text-size-12"> 提成：</span><input
                            type="text" class="ph-inpt" placeholder="5.00"> <span class="text-publ">元/台</span>
                    </div>
        ...
        <ul>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <div class="ph-search-date fl-left">
                            <input name="startDate" type="text" class="form-control form_datetime input-sm" placeholder="选择日期" readonly="readonly" style="background: #ffffff;margin-right: 20px">
                        </div>

                        <div class="ph-search-date fl-left">
                            <input name="endDate" type="text" class="form-control form_datetime input-sm" placeholder="选择日期" readonly="readonly" style="background: #ffffff;margin-right: 20px">
                        </div>
            ...
            <li>
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <div class="ph-search-date fl-left">
                            <input name="issuingDate" type="text" class="form-control form_datetime input-sm" placeholder="选择日期" readonly="readonly" style="background: #ffffff;margin-right: 20px">
                    ...
                    <div class="form-group ">
                        <div class="row" style="height: 70px">
                            <div class="col-sm-offset-4 col-sm-4" style="margin-top: 50px;margin-bottom: 35px;">
                                <button type="submit" class="col-sm-12 btn btn-primary text-strong" style="margin-top: -25px">确认提交</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="addNumberForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group are-line">
                                    <span class="input-group-addon "><i class=" ph-icon ph-renwu"></i></span>
                                    <input type="text" class="form-control input-h J_numberSecond" onblur="chkFirstValue();"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group are-line">
                                    <span class="input-group-addon "><i class=" ph-icon ph-renwu"></i></span>
                                    <input type="text" class="form-control input-h J_numberThird" onblur="chkScendValue();"
