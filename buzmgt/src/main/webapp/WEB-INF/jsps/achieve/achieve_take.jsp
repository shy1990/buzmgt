...
<div class="content main">
    ...
    <div class="row ">
        ...
        <p class="tp-marg"><span class="text-gery text-strong text-fs">达量产品：</span> <span
                class="text-heis">${achieve.machineType.name }——${achieve.good.name }</span></p>
        <!--阶梯提成设置-->
        <div class="jttcsz">
        ...
        <ul>
            <li>
                <dl class="dl-horizontal">
                    <dt>补充说明：</dt>
                    <dd>
                        <div  class="fl-left" style="width: 500px;min-height: 80px;">${achieve.remark }</div>
                    </dd>
                </dl>
            ...
            <li style="margin-top: 30px">
                <dl class="dl-horizontal">
                    <dt>方案起止时间：</dt>
                    <dd>
                        <div> <span class="text-gery tex"><fmt:formatDate value="${achieve.startDate}" pattern="yyyy-MM-dd"/>
                        	至 <fmt:formatDate value="${achieve.endDate}" pattern="yyyy-MM-dd"/> </span></div>
                    </dd>
                </dl>
            </li>
            ...
            <li style="margin-bottom: 200px">
                <dl class="dl-horizontal">
                    <dt>奖罚发放日期：</dt>
                    <dd>
                        <div> <span class="text-gery tex"><fmt:formatDate value="${achieve.issuingDate}" pattern="yyyy-MM-dd"/></span></div>
                    </dd>
                </dl>
            </li>
            <li style="margin-bottom: 200px">
