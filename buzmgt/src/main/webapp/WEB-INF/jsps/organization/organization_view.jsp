...
<link rel="stylesheet" type="text/css"
	href="static/css/organization/purview-organ-setting.css" />
<link rel="stylesheet" type="text/css"
...
<body>
	<div id="j_page_main" class=" content main">
		<h4 class="page-header-region">
			<i class="icon organization-setting-icon"></i>组织结构
		</h4>
		<div class="row">
			<div class="col-md-12">
	...
	<script src="static/js/organization/organizationTree.js"
		type="text/javascript" charset="utf-8"></script>
	<script src='static/js/common.js'></script>
</body>
</html>
