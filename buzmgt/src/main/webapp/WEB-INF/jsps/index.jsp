							...
							<div class="row">
								<div class="col-sm-12">
									<div class="page-header">
										...
										<!-- /BREADCRUMBS -->
										<div class="clearfix">
											<h3 class="content-title pull-left">控制台</h3>
											<!-- DATE RANGE PICKER -->
													...
													<div class="scroller" data-height="450px" data-always-visible="1" data-rail-visible="1">
														<div class="feed-activity clearfix">
															<div>
																...
																<a class="user" href="#"> John Doe </a> accepted your connection request.
																<br>
														...
														<div class="feed-activity clearfix">
															<div>
																...
																<a class="user" href="#"> Jack Doe </a> uploaded a new photo.
																<br>
														...
														<div class="feed-activity clearfix">
															<div>
																...
																<a class="user" href="#"> Jess Doe </a> edited their skills.
																<br>
														...
														<div class="feed-activity clearfix">
															<div>
																...
																<a class="user" href="#"> Divine Doe </a> made a bitcoin payment.
																<br>
														...
														<div class="feed-activity clearfix">
															<div>
																...
																<a class="user" href="#"> Lisbon Doe </a> saved a new document to Dropbox.
																<br>
																<a href="#">Download</a>
														...
														<div class="feed-activity clearfix">
															<div>
																...
																<a class="user" href="#"> Bob Doe </a> pinned a new photo to Pinterest.
																<br>
																<a href="#">Take a look</a>
											...
											<ul class="media-list chat-list">
												<li class="media">
													<a class="pull-left" href="#">
														<img class="media-object" alt="Generic placeholder image" src="static/img/chat/headshot1.jpg">
													</a>
												...
												<li class="media">
													<a class="pull-right" href="#">
														<img class="media-object" alt="Generic placeholder image" src="static/img/chat/headshot2.jpg">
													</a>
												...
												<li class="media">
													<a class="pull-left" href="#">
														<img class="media-object" alt="Generic placeholder image" src="static/img/chat/headshot3.jpg">
													</a>
													<div class="media-body chat-pop">
												...
												<li class="media">
													<a class="pull-left" href="#">
														<img class="media-object" alt="Generic placeholder image" src="static/img/chat/headshot5.jpg">
													</a>
													<div class="media-body chat-pop">
												...
												<li class="media">
													<a class="pull-left" href="#">
														<img class="media-object" alt="Generic placeholder image" src="static/img/chat/headshot4.jpg">
													</a>
													<div class="media-body chat-pop">
