...
<body>
	<ul class="nav nav-sidebar menu">
		<li class="active"><a class="console" href="#">控制台 <span
				class="sr-only"></span></a></li>
		<li class="" role="presentation">
			<!--二级菜单添加menu-second-box--> <a class="menu-second-box management"
			href="" data-toggle="dropdown">业务管理<span
				class="pull-right down-icon"></span></a>
		...
		<li class=""><a class="menu-second-box cli-manage"
			data-toggle="dropdown">客户管理<span class="pull-right down-icon"></span></a>
			<ul class="menu-second">
		...
		<li><a class="menu-second-box statistics" data-toggle="dropdown">统计<span
				class="pull-right down-icon"></span></a>
			<ul class="menu-second">
				<li class=""><a class="business-analysis" href="">商家分析</a></li>
				<li><a href="" class="product-analysis">产品分析</a></li>
			</ul></li>
		<li><a href="" class="menu-second-box basic-settings"
			data-toggle="dropdown">基础设置<span class="pull-right down-icon"></span></a>
			<ul class="menu-second">
