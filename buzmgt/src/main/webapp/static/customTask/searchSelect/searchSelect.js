...
(function ($) {
    ...
    $.fn.multiselect = function (options) {
        var defaults = {
            ...
            searchOptions: {
                'default': '请输入关键字', // search input placeholder text
        ...
        return this.each(function () {
            ...
            $(this).after('<div class="ms-options-wrap"><button>None Selected</button><div class="ms-options"><ul></ul><div class="sj-ms-btn-ok"><button>确定</button></div></div></div>');
            ...
            var okBtn = $(this).next('.ms-options-wrap').find('> .ms-options').find(' button:first-child');
            ...
            optionsWrap.find('input[type="checkbox"]').click(function () {
                ...
                var allput=optionsList.find('input[type="checkbox"]');
                allput.attr("checked",null);
                if(select.val()!=''&&select.val()!=null){
                	var valsdf=select.val();
                   var selectInput=  allput.find('[value="'+valsdf[0]+'"]');
            ...
            var updatePlaceholderText = function () {
                ...
                if (copyWidth > placeWidth) {
                    placeholder.text(selOpts.length + ' 个选择');
                }
